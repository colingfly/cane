...
from mcp_catalog import get_catalog, get_connector, get_categories
...
def _sync_server(server: McpServer, db: Session):
    ...
    from services.mcp_client import discover_tools
...
def test_server_tool(
    ...
    from services.mcp_client import execute_tool
