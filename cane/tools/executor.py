...
def execute_tool(tool, input_data: dict) -> dict:
    ...
    try:
        ...
        if url and url.startswith("/"):
            from cane.core.config import BASE_URL
...
def call_claude_with_tools(
    ...
    """
    from cane.inference.claude import call_with_tools as _sdk_call
    from cane.tools.registry import ToolRef, execute_tool_call
