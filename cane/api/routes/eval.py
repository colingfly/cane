...
from cane.core.rate_limit import check_guest_eval_rate, record_guest_eval_run
...
def list_judge_models(
    ...
    from cane.inference.providers import PROVIDERS, DEFAULT_MODELS
    providers = []
...
def generate_test_cases(
    ...
    from cane.rag.search import build_tenant_where
...
[
  ...
  ...
    ...
    from cane.eval.engine import _call_claude, JUDGE_MODEL
...
def test_target(
    ...
    from cane.eval.engine import _get_external_agent_answer
...
def trigger_schedule_now(
    ...
    from cane.eval.schedule_runner import run_eval_schedule
