...
from cane.auth.jwt import require_admin, hash_password
from cane.core.security import sanitize_form_field, validate_email, validate_password
...
def admin_delete_tenant(tenant_id: str, user: User = Depends(require_admin), db: Session = Depends(get_db)):
    ...
    from cane.eval.models import EvalResult, EvalRun, JudgeCustomRule, JudgeCriteria, TestCase, Environment
