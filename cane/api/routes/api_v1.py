...
from cane.inference.routing import infer, get_model_display
from cane.core.database import get_db
from cane.core.models import Workspace, SearchLog, ApiKey
from cane.tools.models import AgentLink, AgentCommunication, ExternalAgent
...
from cane.rag.context import build_system_prompt
...
async def v1_register_agent(
    ...
    encrypted_token = ""
    if auth_token:
        from cane.core.crypto import encrypt
